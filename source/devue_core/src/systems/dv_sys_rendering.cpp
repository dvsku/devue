...
void dv_sys_rendering::render(dv_scene_model& smodel, dv_camera& camera, dv_lighting& lighting) {
    ...
    static const libutil::uuid SHADER_ID = libutil::create_uuid("integrated_default");
...
void dv_sys_rendering::render(dv_scene_grid& sgrid, dv_camera& camera, dv_lighting& lighting) {
    ...
    static const libutil::uuid SHADER_ID = libutil::create_uuid("integrated_grid");
...
dv_shader* dv_sys_rendering::set_shader(libutil::uuid id) {
